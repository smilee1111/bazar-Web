                        ...
                        <div className="flex items-center gap-2">
                            <Dialog>
                                <DialogTrigger asChild>
                                    <button className="inline-flex items-center gap-2 text-sm text-[#1B4A31] border border-[#DCF0E2] rounded-md px-3 py-1.5 hover:bg-[#F1FAF5]">
                                        <Eye className="h-4 w-4" />
                                        View Details
                                    </button>
                                </DialogTrigger>
                                <DialogContent className="max-w-2xl bg-white border-[1.2px] border-gray-200 text-[#142A1C] rounded-lg p-6 shadow-xl">
