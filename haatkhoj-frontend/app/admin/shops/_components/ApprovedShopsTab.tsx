        ...
        <div className="space-y-4">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <Button
                    ...
                    className="flex items-center gap-2 bg-[#267A4C] text-white hover:bg-[#1C5C39]"
                >
            ...
            {shops.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filteredShops.map((shop) => (
                        <Card key={shop._id} className="hover:shadow-md transition-shadow bg-white border border-[#DCF0E2]">
                                                    ...
                                                    <TabsContent value="reviews" className="space-y-4">
                                                        {detailsLoading ? (
                                                            <div className="flex justify-center py-8">
                                                                <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-[#267A4C]"></div>
                                                            </div>
