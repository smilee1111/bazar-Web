      ...
      <CardContent className="space-y-6 p-8">
        <form className="space-y-6" onSubmit={rhfSubmit(handleSubmit)}>
          ...
          <div className="space-y-4">
            <Label className="text-base font-semibold text-[#142A1C]">Profile Picture</Label>
            <div className="flex items-center gap-8">
              <div className="relative">
                ...
                <label
                  ...
                  className="absolute -bottom-3 -right-3 flex h-10 w-10 items-center justify-center rounded-full bg-[#267A4C] text-white hover:bg-[#1C5C39] cursor-pointer transition-colors shadow-lg"
                >
              ...
              <div className="flex-1">
                <p className="text-sm text-[#1B4A31] mb-2">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="gap-2 border-[#267A4C] text-[#267A4C] hover:bg-[#267A4C] hover:text-white"
                  >
          ...
          <div className="space-y-2">
            <Label htmlFor="password">Password {mode === "edit" && <span className="text-xs text-[#267A4C]">(leave blank to keep)</span>}</Label>
          ...
          <div className="pt-2">
            <Button type="submit" disabled={submitting}
              className="w-full bg-[#267A4C] text-white hover:bg-[#1C5C39] disabled:opacity-60">
